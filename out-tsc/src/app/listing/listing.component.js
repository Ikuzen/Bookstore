...
let ListingComponent = class ListingComponent {
    ...
    subjectQueryBuilder() {
        let subjectQuery = "";
        let subjectArr = [this.book.thriller.query, this.book.fiction.query, this.book.suspense.query, this.book.historical.query, this.book.literary.query];
...
ListingComponent = tslib_1.__decorate([
    Component({
